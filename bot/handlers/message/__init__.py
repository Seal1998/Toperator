...
from bot.handlers.message.callback_message import callback_message_handlers
...
message_handlers = text_message_handlers + callback_message_handlers + shared_message_handlers